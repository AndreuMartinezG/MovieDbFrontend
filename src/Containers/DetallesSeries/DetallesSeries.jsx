...
const DetallesSeries = (props) => {
    ...
    const getDetallesPelicula = async () => {
        ...
        let detallesVideo = `${API_URL}tv/${serieId}?api_key=${API_KEY}&append_to_response=videos`
        ...
        <div className="designDetallesPelicula">
            ...
            <div style={{ width: '85%', margin: '1rem auto' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <AddCarrito movieInfo={props.search} serieId={props.search.id} userFrom={props.credentials.usuario.id} />
                </div>
                <MovieInfo series movie={props.search} detalles={DataFilm}/>
